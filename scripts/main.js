...
//*Crime types
var crimeChart2 = Highcharts.chart('crimeTypeChart', {
    chart: {
        type: 'bar'
    },
    title: {
        text: 'Types of Criminal Arrests in Gainesville, 2016-2020'
    },
    subtitle: {
        text: 'Source: <a href="https://data.cityofgainesville.org/browse?category=Public+Safety&q=&sortBy=relevance">data.cityofgainesville.org</a>'
    },
    xAxis: {
        categories: ['Violent Crimes', 'Property Crimes', 'Drug Crimes'],
        title: {
            text: null
        }
    },
...
var crimeChart3 = Highcharts.chart('crimeTypeBreakdownChart', {
    chart: {
        type: 'column'
    },
    title: {
        text: 'Biggest Changes in Reported Arrests'
    },
    subtitle: {
        text: 'Source: <a href="https://data.cityofgainesville.org/browse?category=Public+Safety&q=&sortBy=relevance">data.cityofgainesville.org</a>'
    },
...
//*ScrollMagic
var crimeDescriptionController = new ScrollMagic.Controller();
var crimeDescriptionScene = new ScrollMagic.Scene({
  triggerElement: '#arrestDescription',
})
.setClassToggle('#arrestDescription', 'show')
.addTo(crimeDescriptionController);
  ...
  .addTo(arrestController);
    ...
    var arrestTypeController = new ScrollMagic.Controller();
    var arrestTypeScene = new ScrollMagic.Scene({
      triggerElement: '#crimeTypeChart',
    })
    .setClassToggle('#crimeTypeChart', 'show')
    .addTo(arrestTypeController);


    var arrestTypeBreakdownController = new ScrollMagic.Controller();
    var arrestTypeBreakdownScene = new ScrollMagic.Scene({
      triggerElement: '#crimeTypeBreakdownChart',
    })
    .setClassToggle('#crimeTypeBreakdownChart', 'show')
    .addTo(arrestTypeBreakdownController);


    var crimeConclusionController = new ScrollMagic.Controller();
    var crimeConclusionScene = new ScrollMagic.Scene({
      triggerElement: '#crimeConclusion',
    })
    .setClassToggle('#crimeConclusion', 'show')
    .addTo(crimeConclusionController);


    var gruDescriptionController = new ScrollMagic.Controller();
    var gruDescriptionScene = new ScrollMagic.Scene({
      triggerElement: '#gruDescription',
    })
    .setClassToggle('#gruDescription', 'show')
    .addTo(gruDescriptionController);
      ...
      .addTo(gruRatesController);
        ...
        var gruConclusionController = new ScrollMagic.Controller();
        var gruConclusionScene = new ScrollMagic.Scene({
          triggerElement: '#gruConclusion',
        })
        .setClassToggle('#gruConclusion', 'show')
        .addTo(gruConclusionController);


        var permitDescriptionController = new ScrollMagic.Controller();
        var permitDescriptionScene = new ScrollMagic.Scene({
          triggerElement: '#permitDescription',
        })
        .setClassToggle('#permitDescription', 'show')
        .addTo(permitDescriptionController);
          ...
          .addTo(permitController);
            ...
            var permitConclusionController = new ScrollMagic.Controller();
            var permitConclusionScene = new ScrollMagic.Scene({
              triggerElement: '#permitConclusion',
            })
            .setClassToggle('#permitConclusion', 'show')
            .addTo(permitConclusionController);


            var expenseDescriptionController = new ScrollMagic.Controller();
            var expenseDescriptionScene = new ScrollMagic.Scene({
              triggerElement: '#expenseDescription',
            })
            .setClassToggle('#expenseDescription', 'show')
            .addTo(expenseDescriptionController);
